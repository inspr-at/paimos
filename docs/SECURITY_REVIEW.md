...
- [ ] Do binary raster signatures take precedence over SVG/HTML text in inert metadata, while explicitly declared active types and disguised SVG/HTML remain rejected? (PAI-1019; C2PA PNG regression.)
