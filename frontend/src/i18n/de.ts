...
export default {
  ...
  agentMode: {
    ...
    card: {
      ...
      gone: 'Nicht mehr aktiv — verschwindet, sobald du pausierst',
    },
    lanes: {
      ungrouped: 'Ohne Epic',
    ...
    detail: {
      level: 'Detail',
      levelTitle: { 1: 'Detail 1 — ausgewählte Lieferung', 10: 'Detail 10 — Lanes und Karten', 100: 'Detail 100 — Streams' },
      focusAria: 'Ausgewählte Lieferung',
      zoomOut: 'Übersicht',
      position: '{i} von {n}',
      prev: 'Zurück',
      next: 'Weiter',
      seamOne: 'Stufenkette, Evidenz und der Ticket-Editor kommen mit PAI-806. Auswahl, Lane und Schätzwahrheit werden bereits mit der Übersicht geteilt.',
      seamHundred: 'Aggregierte Streams und Attention-Triage kommen mit PAI-807. Die Zahlen unten verwenden dieselbe Lane- und Zustandssprache wie die Karten.',
    },
    streams: {
      title: 'Liefer-Streams',
      lane: 'Lane',
      active: 'Aktiv',
    ...
    narration: {
      ...
      selectionNoEta: 'Keine vertrauenswürdige Schätzung: {reason}.',
      ...
      moved: '{previous} ist nicht mehr aktiv; {key} ist jetzt ausgewählt.',
      ...
      listening: 'Höre zu',
      listeningHint: 'Frag nach jeder Lieferung',
      keysTitle: 'Tastatur',
      keysHint: '← → Auswahl bewegen · Enter Details · Esc herauszoomen',
      voiceSeam: 'Sprachnavigation kommt mit PAI-808.',
    },
    a11y: {
      canvas: 'Lieferungen',
