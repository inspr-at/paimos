...
describe('AgentModeDeliveryCard (PAI-805)', () => {
  ...
  it('shows eligible low-confidence ETA as bounds only, without point landing or remaining-time claims', async () => {
    const ranged: Delivery = {
      ...ten[0],
      eta: {
        ...ten[0].eta!,
        confidence: 'low',
        ...
        pessimisticAt: '2026-08-20T15:05:00Z',
      },
    }
