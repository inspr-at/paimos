...
run_package() {
  ...
  case "$package" in
    ...
    ./externalstage)
      ...
      run_race ./externalstage '^(TestConcurrentCreateCommitsOneHandoffAndOneReplay|TestServiceOwnerLifecycleReplayHeartbeatAndRestart|TestServiceReportV2PersistsExplicitReleaseIdentityAndBindsReplay)$'
      ;;
    ./managedharness)
