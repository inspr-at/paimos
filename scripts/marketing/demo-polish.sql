...
-- 3. Give PAI-1 one relevant, deterministic memory so the flagship
--    workbench demonstrates retrieved project knowledge instead of an
--    empty panel. The insert and relation are re-run safe.
INSERT INTO issues
...
-- 4. A finished Voice Intake session, so the flagship 5.x surface shows
