...
func TestAgentIntercomRunbookPinsReleaseAndAdministratorBoundaries(t *testing.T) {
	...
	for _, claim := range []string{
		...
		"guided start, runtime-management, and Habitat lifecycle workflows in this guide are available in 26.09.06.21.31",
		"require matching Paimos server, CLI, and daemon builds",
		"Release 26.09.05 does not include these workflows",
		"use the verified corrective release 26.09.06.21.31",
