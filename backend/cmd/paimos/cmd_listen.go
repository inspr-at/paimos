...
func listenCmd() *cobra.Command {
	...
	c.Flags().StringVar(&deliver, "deliver", "", "deliver each message through a registered local adapter (codex, agentd_codex, agentd_claude, agentd_pi, agentd_cursor, claude) or grok, then acknowledge")
