...
func RegisterBuiltins(registry *Registry) error {
	for _, plugin := range []Plugin{CodexPlugin{}, AgentdCodexPlugin{}, AgentdClaudePlugin{}, AgentdPiPlugin{}, ClaudePlugin{}, ClaudePlugin{Channel: true}, GrokRoutinePlugin{}, ManagedPlugin{}} {
